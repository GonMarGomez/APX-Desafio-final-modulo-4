...
function getContent() {
  return fetch(
    "https://cdn.contentful.com/spaces/6i04s7t927m9/environments/master/entries?access_token=e2mGaPLdxAvyOV8VXo5YtwyPVaindzvXp9_LmWw_9mw&content_type=portfolioDf"
  )
    .then((res) => {
      return res.json();
    })
